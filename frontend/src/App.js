...
function App() {
  ...
  const handleRegister = async () => {
    const res = await fetch('https://my-first-app-memorable.onrender.com/api/auth/register', {
      method: 'POST',
  ...
  const handleLogin = async () => {
    const res = await fetch('https://my-first-app-memorable.onrender.com/api/auth/login', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ username, password })
    });
  ...
  const handleProtected = async () => {
    const res = await fetch('https://my-first-app-memorable.onrender.com/api/protected', {
      method: 'GET',
